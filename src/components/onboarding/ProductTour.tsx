...
export default function ProductTour() {
  ...
  const below = !rect || spaceBelow > 220;
  const cardTop = rect ? (below ? rect.top + rect.height + PADDING + 8 : rect.top - 200) : 120;
  const cardLeft = rect
  ...
  return createPortal(
    <div className="fixed inset-0 z-[100]" role="presentation">
      ...
      <div
        ...
        tabIndex={-1}
        className="absolute w-[320px] rounded-2xl border border-white/15 bg-[#111] p-5 shadow-2xl outline-none transition-all duration-300"
